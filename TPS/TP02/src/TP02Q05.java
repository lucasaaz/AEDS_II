...
class Lista {
	 ...
	 */
	public boolean inserirInicio(Film item) {
		if (n < array.length) {
	 ...
	 * @param Elemento a ser inserido.
	 */
	public boolean inserirFim(Film item) {
		// validar insercao
		if (n < array.length) {
			array[n] = item;
			n++;
	 ...
	 */
	public boolean inserir(int pos, Film item) {
        ...
        try{
            ...
            for(int j = 0; j < 30; j++){
                ...
                if(str.charAt(0) == 'I' && str.charAt(1) == 'I'){
                    filme = new Film();
                    filme.ler("/tmp/filmes/" + lista.limpaString(str,3));
                    lista.inserirInicio(filme);
                } else if(str.charAt(0) == 'I' && str.charAt(1) == '*'){
                    filme = new Film();
                    filme.ler("/tmp/filmes/" + lista.limpaString(str,6));
                    int posicao = lista.myParseInt(str);
                    lista.inserir(posicao,filme);
